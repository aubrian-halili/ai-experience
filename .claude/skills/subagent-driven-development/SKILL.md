...
description: Use when the user asks to "parallelize this work", "use subagents", "multi-agent", "orchestrate agents", mentions "large refactor across modules", or references a plan with independent tasks.
